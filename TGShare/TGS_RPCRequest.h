...
@interface TGS_RPCRequest : NSObject
...
typedef void (^RPCSuccessHandler)(TGS_RPCRequest *request, id response);
typedef void (^RPCErrorHandler)(TGS_RPCRequest *request, RpcError *error);
