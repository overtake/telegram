...
@interface TLmessages_Chat : TLObject
@end
...
@interface TL_inputPeerEmpty : TLInputPeer
+(TL_inputPeerEmpty*)create;
@end
@interface TL_inputPeerSelf : TLInputPeer
+(TL_inputPeerSelf*)create;
@end
@interface TL_inputPeerContact : TLInputPeer
+(TL_inputPeerContact*)createWithUser_id:(int)user_id;
@end
@interface TL_inputPeerForeign : TLInputPeer
+(TL_inputPeerForeign*)createWithUser_id:(int)user_id access_hash:(long)access_hash;
@end
@interface TL_inputPeerChat : TLInputPeer
...
@interface TL_inputUserEmpty : TLInputUser
+(TL_inputUserEmpty*)create;
@end
@interface TL_inputUserSelf : TLInputUser
+(TL_inputUserSelf*)create;
@end
@interface TL_inputUserContact : TLInputUser
+(TL_inputUserContact*)createWithUser_id:(int)user_id;
@end
@interface TL_inputUserForeign : TLInputUser
...
@interface TL_inputPhoneContact : TLInputContact
...
@end
@interface TL_inputMediaContact : TLInputMedia
...
@end
@interface TL_inputMediaAudio : TLInputMedia
...
@interface TL_inputChatPhotoEmpty : TLInputChatPhoto
+(TL_inputChatPhotoEmpty*)create;
@end
@interface TL_inputChatUploadedPhoto : TLInputChatPhoto
+(TL_inputChatUploadedPhoto*)createWithFile:(TLInputFile*)file crop:(TLInputPhotoCrop*)crop;
@end
@interface TL_inputChatPhoto : TLInputChatPhoto
...
@interface TL_inputGeoPointEmpty : TLInputGeoPoint
+(TL_inputGeoPointEmpty*)create;
@end
@interface TL_inputGeoPoint : TLInputGeoPoint
...
@interface TL_inputPhotoEmpty : TLInputPhoto
+(TL_inputPhotoEmpty*)create;
@end
@interface TL_inputPhoto : TLInputPhoto
...
@interface TL_inputVideoEmpty : TLInputVideo
+(TL_inputVideoEmpty*)create;
@end
@interface TL_inputVideo : TLInputVideo
...
@interface TL_inputPhotoCropAuto : TLInputPhotoCrop
+(TL_inputPhotoCropAuto*)create;
@end
@interface TL_inputPhotoCrop : TLInputPhotoCrop
...
@interface TL_inputAppEvent : TLInputAppEvent
...
@interface TL_peerUser : TLPeer
+(TL_peerUser*)createWithUser_id:(int)user_id;
@end
@interface TL_peerChat : TLPeer
...
@interface TL_storage_fileUnknown : TLstorage_FileType
+(TL_storage_fileUnknown*)create;
@end
@interface TL_storage_fileJpeg : TLstorage_FileType
+(TL_storage_fileJpeg*)create;
@end
@interface TL_storage_fileGif : TLstorage_FileType
+(TL_storage_fileGif*)create;
@end
@interface TL_storage_filePng : TLstorage_FileType
+(TL_storage_filePng*)create;
@end
@interface TL_storage_filePdf : TLstorage_FileType
+(TL_storage_filePdf*)create;
@end
@interface TL_storage_fileMp3 : TLstorage_FileType
+(TL_storage_fileMp3*)create;
@end
@interface TL_storage_fileMov : TLstorage_FileType
+(TL_storage_fileMov*)create;
@end
@interface TL_storage_filePartial : TLstorage_FileType
+(TL_storage_filePartial*)create;
@end
@interface TL_storage_fileMp4 : TLstorage_FileType
+(TL_storage_fileMp4*)create;
@end
@interface TL_storage_fileWebp : TLstorage_FileType
...
@end
@interface TL_userContact : TLUser
...
@end
@interface TL_userRequest : TLUser
...
@end
@interface TL_userForeign : TLUser
...
@end
@interface TL_userDeleted : TLUser
...
@interface TL_userProfilePhotoEmpty : TLUserProfilePhoto
+(TL_userProfilePhotoEmpty*)create;
@end
@interface TL_userProfilePhoto : TLUserProfilePhoto
...
@interface TL_userStatusEmpty : TLUserStatus
+(TL_userStatusEmpty*)create;
@end
@interface TL_userStatusOnline : TLUserStatus
+(TL_userStatusOnline*)createWithExpires:(int)expires;
@end
@interface TL_userStatusOffline : TLUserStatus
...
@interface TL_chatEmpty : TLChat
+(TL_chatEmpty*)createWithN_id:(int)n_id;
@end
@interface TL_chat : TLChat
...
@interface TL_chatParticipant : TLChatParticipant
...
@interface TL_chatParticipantsForbidden : TLChatParticipants
+(TL_chatParticipantsForbidden*)createWithChat_id:(int)chat_id;
@end
@interface TL_chatParticipants : TLChatParticipants
...
@interface TL_chatPhotoEmpty : TLChatPhoto
+(TL_chatPhotoEmpty*)create;
@end
@interface TL_chatPhoto : TLChatPhoto
...
@interface TL_messageEmpty : TLMessage
...
@end
@interface TL_messageMediaContact : TLMessageMedia
...
@end
@interface TL_messageMediaUnsupported : TLMessageMedia
+(TL_messageMediaUnsupported*)createWithBytes:(NSData*)bytes;
@end
@interface TL_messageMediaDocument : TLMessageMedia
...
@end
@interface TL_messageActionChatCreate : TLMessageAction
+(TL_messageActionChatCreate*)createWithTitle:(NSString*)title users:(NSMutableArray*)users;
@end
@interface TL_messageActionChatEditTitle : TLMessageAction
+(TL_messageActionChatEditTitle*)createWithTitle:(NSString*)title;
@end
@interface TL_messageActionChatEditPhoto : TLMessageAction
+(TL_messageActionChatEditPhoto*)createWithPhoto:(TLPhoto*)photo;
@end
@interface TL_messageActionChatDeletePhoto : TLMessageAction
+(TL_messageActionChatDeletePhoto*)create;
@end
@interface TL_messageActionChatAddUser : TLMessageAction
+(TL_messageActionChatAddUser*)createWithUser_id:(int)user_id;
@end
@interface TL_messageActionChatDeleteUser : TLMessageAction
+(TL_messageActionChatDeleteUser*)createWithUser_id:(int)user_id;
@end
@interface TL_messageActionGeoChatCreate : TLMessageAction
...
@interface TL_photoEmpty : TLPhoto
...
@interface TL_videoEmpty : TLVideo
...
@interface TL_geoPointEmpty : TLGeoPoint
+(TL_geoPointEmpty*)create;
@end
@interface TL_geoPoint : TLGeoPoint
+(TL_geoPoint*)createWithN_long:(double)n_long lat:(double)lat;
@end
	
@interface TLauth_CheckedPhone()
@property Boolean phone_registered;
@property Boolean phone_invited;
@end

@interface TL_auth_checkedPhone : TLauth_CheckedPhone
...
@interface TL_auth_sentCode : TLauth_SentCode
...
@end
@interface TL_auth_sentAppCode : TLauth_SentCode
...
@interface TL_auth_exportedAuthorization : TLauth_ExportedAuthorization
...
@interface TL_inputNotifyPeer : TLInputNotifyPeer
+(TL_inputNotifyPeer*)createWithPeer:(TLInputPeer*)peer;
@end
@interface TL_inputNotifyUsers : TLInputNotifyPeer
+(TL_inputNotifyUsers*)create;
@end
@interface TL_inputNotifyChats : TLInputNotifyPeer
+(TL_inputNotifyChats*)create;
@end
@interface TL_inputNotifyAll : TLInputNotifyPeer
+(TL_inputNotifyAll*)create;
@end
@interface TL_inputNotifyGeoChatPeer : TLInputNotifyPeer
...
@interface TL_inputPeerNotifyEventsEmpty : TLInputPeerNotifyEvents
+(TL_inputPeerNotifyEventsEmpty*)create;
@end
@interface TL_inputPeerNotifyEventsAll : TLInputPeerNotifyEvents
...
@interface TL_inputPeerNotifySettings : TLInputPeerNotifySettings
...
@interface TL_peerNotifyEventsEmpty : TLPeerNotifyEvents
+(TL_peerNotifyEventsEmpty*)create;
@end
@interface TL_peerNotifyEventsAll : TLPeerNotifyEvents
...
@interface TL_peerNotifySettingsEmpty : TLPeerNotifySettings
+(TL_peerNotifySettingsEmpty*)create;
@end
@interface TL_peerNotifySettings : TLPeerNotifySettings
...
@interface TL_contact : TLContact
...
@interface TL_importedContact : TLImportedContact
...
@interface TL_contactBlocked : TLContactBlocked
...
@interface TL_contactSuggested : TLContactSuggested
...
@interface TL_contactStatus : TLContactStatus
...
@interface TL_chatLocated : TLChatLocated
...
@property (nonatomic, strong) TLcontacts_MyLink* my_link;
@property (nonatomic, strong) TLcontacts_ForeignLink* foreign_link;
@property (nonatomic, strong) TLUser* user;
@end

@interface TL_contacts_link : TLcontacts_Link
...
@interface TL_contacts_importedContacts : TLcontacts_ImportedContacts
...
@interface TL_contacts_blocked : TLcontacts_Blocked
+(TL_contacts_blocked*)createWithBlocked:(NSMutableArray*)blocked users:(NSMutableArray*)users;
@end
@interface TL_contacts_blockedSlice : TLcontacts_Blocked
...
@interface TL_contacts_suggested : TLcontacts_Suggested
...
@interface TL_messages_dialogs : TLmessages_Dialogs
...
@end
@interface TL_messages_dialogsSlice : TLmessages_Dialogs
...
@interface TL_messages_messageEmpty : TLmessages_Message
+(TL_messages_messageEmpty*)create;
@end
@interface TL_messages_message : TLmessages_Message
...
@interface TLmessages_Chat()
@property (nonatomic, strong) TLChat* chat;
@property (nonatomic, strong) NSMutableArray* users;
@end

@interface TL_messages_chat : TLmessages_Chat
...
@interface TL_messages_chats : TLmessages_Chats
...
@interface TL_messages_chatFull : TLmessages_ChatFull
...
@interface TL_messages_affectedHistory : TLmessages_AffectedHistory
...
@interface TL_inputMessagesFilterEmpty : TLMessagesFilter
+(TL_inputMessagesFilterEmpty*)create;
@end
@interface TL_inputMessagesFilterPhotos : TLMessagesFilter
+(TL_inputMessagesFilterPhotos*)create;
@end
@interface TL_inputMessagesFilterVideo : TLMessagesFilter
+(TL_inputMessagesFilterVideo*)create;
@end
@interface TL_inputMessagesFilterPhotoVideo : TLMessagesFilter
+(TL_inputMessagesFilterPhotoVideo*)create;
@end
@interface TL_inputMessagesFilterDocument : TLMessagesFilter
...
@property Boolean blocked;
@property (nonatomic, strong) TLNotifyPeer* peer;
@property (nonatomic, strong) TLPeerNotifySettings* notify_settings;
@property (nonatomic, strong) NSString* type;
@property (nonatomic, strong) TLMessageMedia* media;
...
@end
@interface TL_updateRestoreMessages : TLUpdate
...
@end
@interface TL_updateActivation : TLUpdate
+(TL_updateActivation*)createWithUser_id:(int)user_id;
@end
@interface TL_updateNewAuthorization : TLUpdate
...
@interface TL_updates_state : TLupdates_State
...
@interface TL_updates_differenceEmpty : TLupdates_Difference
+(TL_updates_differenceEmpty*)createWithDate:(int)date seq:(int)seq;
@end
@interface TL_updates_difference : TLupdates_Difference
...
@end
@interface TL_updates_differenceSlice : TLupdates_Difference
...
@interface TL_updatesTooLong : TLUpdates
...
@end
@interface TL_updatesCombined : TLUpdates
...
@end
@interface TL_updates : TLUpdates
...
@interface TL_photos_photos : TLphotos_Photos
+(TL_photos_photos*)createWithPhotos:(NSMutableArray*)photos users:(NSMutableArray*)users;
@end
@interface TL_photos_photosSlice : TLphotos_Photos
...
@interface TL_photos_photo : TLphotos_Photo
...
@interface TL_upload_file : TLupload_File
...
@interface TL_nearestDc : TLNearestDc
...
@interface TL_help_inviteText : TLhelp_InviteText
...
@interface TL_inputGeoChat : TLInputGeoChat
...
@interface TL_geoChatMessageEmpty : TLGeoChatMessage
+(TL_geoChatMessageEmpty*)createWithChat_id:(int)chat_id n_id:(int)n_id;
@end
@interface TL_geoChatMessage : TLGeoChatMessage
...
@end
@interface TL_geoChatMessageService : TLGeoChatMessage
...
@interface TL_geochats_statedMessage : TLgeochats_StatedMessage
...
@interface TL_geochats_located : TLgeochats_Located
...
@interface TL_encryptedChatEmpty : TLEncryptedChat
+(TL_encryptedChatEmpty*)createWithN_id:(int)n_id;
@end
@interface TL_encryptedChatWaiting : TLEncryptedChat
...
@end
@interface TL_encryptedChatRequested : TLEncryptedChat
...
@end
@interface TL_encryptedChat : TLEncryptedChat
...
@end
@interface TL_encryptedChatDiscarded : TLEncryptedChat
...
@interface TL_inputEncryptedChat : TLInputEncryptedChat
...
@interface TL_encryptedFileEmpty : TLEncryptedFile
+(TL_encryptedFileEmpty*)create;
@end
@interface TL_encryptedFile : TLEncryptedFile
...
@interface TL_inputEncryptedFileEmpty : TLInputEncryptedFile
+(TL_inputEncryptedFileEmpty*)create;
@end
@interface TL_inputEncryptedFileUploaded : TLInputEncryptedFile
...
@end
@interface TL_inputEncryptedFile : TLInputEncryptedFile
+(TL_inputEncryptedFile*)createWithN_id:(long)n_id access_hash:(long)access_hash;
@end
@interface TL_inputEncryptedFileBigUploaded : TLInputEncryptedFile
...
@interface TL_encryptedMessage : TLEncryptedMessage
...
@end
@interface TL_encryptedMessageService : TLEncryptedMessage
...
@interface TL_messages_dhConfigNotModified : TLmessages_DhConfig
+(TL_messages_dhConfigNotModified*)createWithRandom:(NSData*)random;
@end
@interface TL_messages_dhConfig : TLmessages_DhConfig
...
@interface TL_messages_sentEncryptedMessage : TLmessages_SentEncryptedMessage
+(TL_messages_sentEncryptedMessage*)createWithDate:(int)date;
@end
@interface TL_messages_sentEncryptedFile : TLmessages_SentEncryptedMessage
...
@interface TL_inputAudioEmpty : TLInputAudio
+(TL_inputAudioEmpty*)create;
@end
@interface TL_inputAudio : TLInputAudio
...
@interface TL_inputDocumentEmpty : TLInputDocument
+(TL_inputDocumentEmpty*)create;
@end
@interface TL_inputDocument : TLInputDocument
...
@interface TL_audioEmpty : TLAudio
+(TL_audioEmpty*)createWithN_id:(long)n_id;
@end
@interface TL_audio : TLAudio
...
@interface TL_help_support : TLhelp_Support
...
@interface TL_notifyPeer : TLNotifyPeer
+(TL_notifyPeer*)createWithPeer:(TLPeer*)peer;
@end
@interface TL_notifyUsers : TLNotifyPeer
+(TL_notifyUsers*)create;
@end
@interface TL_notifyChats : TLNotifyPeer
+(TL_notifyChats*)create;
@end
@interface TL_notifyAll : TLNotifyPeer
+(TL_notifyAll*)create;
@end
...
@end
@interface TL_sendMessageCancelAction : TLSendMessageAction
+(TL_sendMessageCancelAction*)create;
@end
@interface TL_sendMessageRecordVideoAction : TLSendMessageAction
...
@end
@interface TL_sendMessageChooseContactAction : TLSendMessageAction
...
@interface TL_contactFound : TLContactFound
...
@interface TL_contacts_found : TLcontacts_Found
...
@interface TL_privacyKeyStatusTimestamp : TLPrivacyKey
...
@interface TL_privacyValueAllowContacts : TLPrivacyRule
+(TL_privacyValueAllowContacts*)create;
@end
@interface TL_privacyValueAllowAll : TLPrivacyRule
+(TL_privacyValueAllowAll*)create;
@end
@interface TL_privacyValueAllowUsers : TLPrivacyRule
+(TL_privacyValueAllowUsers*)createWithUsers:(NSMutableArray*)users;
@end
@interface TL_privacyValueDisallowContacts : TLPrivacyRule
+(TL_privacyValueDisallowContacts*)create;
@end
@interface TL_privacyValueDisallowAll : TLPrivacyRule
+(TL_privacyValueDisallowAll*)create;
@end
@interface TL_privacyValueDisallowUsers : TLPrivacyRule
...
@interface TL_account_privacyRules : TLaccount_PrivacyRules
...
@interface TL_proto_message : TLProtoMessage
...
@interface TL_msg_container : TLProtoMessageContainer
...
@interface TL_req_pq : TLResPQ
+(TL_req_pq*)createWithNonce:(NSData*)nonce;
@end
@interface TL_resPQ : TLResPQ
...
@interface TL_server_DH_inner_data : TLServer_DH_inner_data
...
@interface TL_p_q_inner_data : TLP_Q_inner_data
...
@interface TL_req_DH_params : TLServer_DH_Params
...
@interface TL_client_DH_inner_data : TLClient_DH_Inner_Data
...
@interface TL_set_client_DH_params : TLSet_client_DH_params_answer
...
@interface TL_ping : TLPong
+(TL_ping*)createWithPing_id:(long)ping_id;
@end
@interface TL_pong : TLPong
...
@interface TL_new_session_created : TLNewSession
...
@interface TL_rpc_result : TLRpcResult
...
@interface TL_rpc_error : TLRpcError
...
@interface TL_rsa_public_key : TLRSAPublicKey
...
@interface TL_msgs_ack : TLMsgsAck
...
@interface TL_rpc_drop_answer : TLRpcDropAnswer
+(TL_rpc_drop_answer*)createWithReq_msg_id:(long)req_msg_id;
@end
@interface TL_rpc_answer_unknown : TLRpcDropAnswer
+(TL_rpc_answer_unknown*)create;
@end
@interface TL_rpc_answer_dropped_running : TLRpcDropAnswer
+(TL_rpc_answer_dropped_running*)create;
@end
@interface TL_rpc_answer_dropped : TLRpcDropAnswer
...
@interface TL_get_future_salts : TLFutureSalts
+(TL_get_future_salts*)createWithNum:(int)num;
@end
@interface TL_future_salts : TLFutureSalts
...
@interface TL_future_salt : TLFutureSalt
...
@interface TL_destroy_session : TLDestroySessionRes
+(TL_destroy_session*)createWithSession_id:(long)session_id;
@end
@interface TL_destroy_session_ok : TLDestroySessionRes
+(TL_destroy_session_ok*)createWithSession_id:(long)session_id;
@end
@interface TL_destroy_session_none : TLDestroySessionRes
...
@interface TL_msg_copy : TLProtoMessageCopy
...
@interface TL_gzip_packed : TLObject
...
@interface TL_http_wait : TLHttpWait
...
@interface TL_msgs_state_req : TLMsgsStateReq
...
@interface TL_msgs_state_info : TLMsgsStateInfo
...
@interface TL_msgs_all_info : TLMsgsAllInfo
