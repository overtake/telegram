...
- (NSArray *)locationsOfLinks
{
    ...
    NSRegularExpression *regex = [NSRegularExpression regularExpressionWithPattern:@"((?<!\\w)@[A-Za-z][A-Za-z0-9_]{5,100}+)" options:NSRegularExpressionCaseInsensitive error:&error];
