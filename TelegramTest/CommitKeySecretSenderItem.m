...
-(id)initWithConversation:(TL_conversation *)conversation exchange_id:(long)exchange_id key_fingerprint:(long)key_fingerprint {
    if(self = [super initWithConversation:conversation]) {
        ...
        self.action = [[TGSecretAction alloc] initWithActionId:[MessageSender getFutureMessageId] chat_id:conversation.peer.chat_id decryptedData:[self decryptedMessageLayer]  senderClass:[CommitKeySecretSenderItem class] layer:self.params.layer];
