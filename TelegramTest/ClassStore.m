...
//  Telegram
//
    //  Created by keepcoder on 15.06.15.
...
+(void)initialize {
   ...
   [cs_classes setObject:[TL_message class] forKey:[NSNumber numberWithInt:-1023016155]];
   ...
   [cs_classes setObject:[TL_replyKeyboardMarkup class] forKey:[NSNumber numberWithInt:-711197647]];
