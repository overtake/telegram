...
+(void)initialize {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [cs_classes setObject:[TL_chatFull class] forKey:[NSNumber numberWithInt:-366793041]];
        ...
        [cs_classes setObject:[TL_botInfo class] forKey:[NSNumber numberWithInt:93204619]];
