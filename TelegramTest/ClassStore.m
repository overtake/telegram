...
+(void)initialize {
   ...
   [cs_classes setObject:[TL_inputBotContextResult class] forKey:[NSNumber numberWithInt:-1535618875]];
   ...
   [cs_classes setObject:[TL_inputMediaContextBotResult class] forKey:[NSNumber numberWithInt:1215434728]];
