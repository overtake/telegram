...
+(void)initialize {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [cs_classes setObject:[TL_inputPeerContact class] forKey:[NSNumber numberWithInt:270785512]];
        [cs_classes setObject:[TL_inputPeerForeign class] forKey:[NSNumber numberWithInt:-1690012891]];
        ...
        [cs_classes setObject:[TL_inputUserContact class] forKey:[NSNumber numberWithInt:-2031530139]];
        [cs_classes setObject:[TL_inputUserForeign class] forKey:[NSNumber numberWithInt:1700689151]];
        ...
        [cs_classes setObject:[TL_inputMediaUploadedVideo class] forKey:[NSNumber numberWithInt:-515910468]];
        [cs_classes setObject:[TL_inputMediaUploadedThumbVideo class] forKey:[NSNumber numberWithInt:-1761896484]];
        ...
        [cs_classes setObject:[TL_chat class] forKey:[NSNumber numberWithInt:1855757255]];
        [cs_classes setObject:[TL_chatForbidden class] forKey:[NSNumber numberWithInt:-83047359]];
        [cs_classes setObject:[TL_chatFull class] forKey:[NSNumber numberWithInt:-891418735]];
        ...
        [cs_classes setObject:[TL_message class] forKey:[NSNumber numberWithInt:-1481959023]];
        ...
        [cs_classes setObject:[TL_photo class] forKey:[NSNumber numberWithInt:-1014792074]];
        ...
        [cs_classes setObject:[TL_video class] forKey:[NSNumber numberWithInt:-291550643]];
        ...
        [cs_classes setObject:[TL_auth_authorization class] forKey:[NSNumber numberWithInt:-155815004]];
        ...
        [cs_classes setObject:[TL_userFull class] forKey:[NSNumber numberWithInt:1997575642]];
        ...
        [cs_classes setObject:[TL_chatLocated class] forKey:[NSNumber numberWithInt:909233996]];
        ...
        [cs_classes setObject:[TL_messages_messageEmpty class] forKey:[NSNumber numberWithInt:1062078024]];
        [cs_classes setObject:[TL_messages_sentMessage class] forKey:[NSNumber numberWithInt:1279084531]];
        ...
        [cs_classes setObject:[TL_updateShortMessage class] forKey:[NSNumber numberWithInt:-312729305]];
        [cs_classes setObject:[TL_updateShortChatMessage class] forKey:[NSNumber numberWithInt:1378061116]];
        ...
        [cs_classes setObject:[TL_dcOption class] forKey:[NSNumber numberWithInt:784507964]];
        ...
        [cs_classes setObject:[TL_messages_sentMessageLink class] forKey:[NSNumber numberWithInt:899786339]];
        [cs_classes setObject:[TL_inputGeoChat class] forKey:[NSNumber numberWithInt:1960072954]];
        [cs_classes setObject:[TL_inputNotifyGeoChatPeer class] forKey:[NSNumber numberWithInt:1301143240]];
        [cs_classes setObject:[TL_geoChat class] forKey:[NSNumber numberWithInt:1978329690]];
        [cs_classes setObject:[TL_geoChatMessageEmpty class] forKey:[NSNumber numberWithInt:1613830811]];
        [cs_classes setObject:[TL_geoChatMessage class] forKey:[NSNumber numberWithInt:1158019297]];
        [cs_classes setObject:[TL_geoChatMessageService class] forKey:[NSNumber numberWithInt:-749755826]];
        [cs_classes setObject:[TL_geochats_statedMessage class] forKey:[NSNumber numberWithInt:397498251]];
        [cs_classes setObject:[TL_geochats_located class] forKey:[NSNumber numberWithInt:1224651367]];
        [cs_classes setObject:[TL_geochats_messages class] forKey:[NSNumber numberWithInt:-783127119]];
        [cs_classes setObject:[TL_geochats_messagesSlice class] forKey:[NSNumber numberWithInt:-1135057944]];
        [cs_classes setObject:[TL_messageActionGeoChatCreate class] forKey:[NSNumber numberWithInt:1862504124]];
        [cs_classes setObject:[TL_messageActionGeoChatCheckin class] forKey:[NSNumber numberWithInt:209540062]];
        [cs_classes setObject:[TL_updateNewGeoChatMessage class] forKey:[NSNumber numberWithInt:1516823543]];
        ...
        [cs_classes setObject:[TL_audio class] forKey:[NSNumber numberWithInt:-945003370]];
        ...
        [cs_classes setObject:[TL_contactFound class] forKey:[NSNumber numberWithInt:-360210539]];
        [cs_classes setObject:[TL_contacts_found class] forKey:[NSNumber numberWithInt:90570766]];
        ...
        [cs_classes setObject:[TL_documentAttributeSticker class] forKey:[NSNumber numberWithInt:-1723033470]];
        [cs_classes setObject:[TL_documentAttributeVideo class] forKey:[NSNumber numberWithInt:1494273227]];
        [cs_classes setObject:[TL_documentAttributeAudio class] forKey:[NSNumber numberWithInt:85215461]];
        ...
        [cs_classes setObject:[TL_messages_allStickers class] forKey:[NSNumber numberWithInt:-588304126]];
        ...
        [cs_classes setObject:[TL_updateWebPage class] forKey:[NSNumber numberWithInt:751004017]];
        ...
        [cs_classes setObject:[TL_webPage class] forKey:[NSNumber numberWithInt:-1558273867]];
        ...
        [cs_classes setObject:[TL_chatInvite class] forKey:[NSNumber numberWithInt:-829325875]];
