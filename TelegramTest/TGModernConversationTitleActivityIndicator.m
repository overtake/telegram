//
//  TGModernConversationTitleActivityIndicator.m
//  Telegram
//
//  Created by keepcoder on 23/03/16.
...
- (void)drawRect:(CGRect)__unused rect
{
    ...
    switch (_type)
    {
        ...
        case TGModernConversationTitleActivityIndicatorTypeUploading:
        {
            ...
            CGFloat progressWidth = 30.0f / 2.0f;
            CGFloat progressHeight = 10.0f / 2.0f;
            ...
            NSColor *dotsColor = [NSColor colorWithWhite:247.0f / 255.0f alpha:1.0f];
            CGContextSetFillColorWithColor(context, dotsColor.CGColor);
