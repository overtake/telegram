...
#define TGSystemLightFont(s) NSAppKitVersionNumber > NSAppKitVersionNumber10_10_Max ? [NSFont fontWithName:@".SFNSDisplay-Regular" size:(s)] : [NSFont fontWithName:@"HelveticaNeue-Light" size:(s)]
