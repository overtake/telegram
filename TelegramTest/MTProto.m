...
-(void)setFwd_post:(int)fwd_post
{
   super.fwd_post = fwd_post;
                
    if(super.fwd_post == 0)  { super.flags&= ~ (1 << 12) ;} else { super.flags|= (1 << 12); }
}            
