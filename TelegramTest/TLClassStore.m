...
- (id)init {
    ...
    if(self) {
        ...
        [self.classes setObject:[TL_updateShortMessage class] forKey:[NSNumber numberWithInt:-1199725647]];
        [self.classes setObject:[TL_updateShortChatMessage class] forKey:[NSNumber numberWithInt:552099309]];
