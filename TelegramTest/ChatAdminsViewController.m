...
-(void)reloadData {
    ...
    GeneralSettingsBlockHeaderItem *fakeItem = [[GeneralSettingsBlockHeaderItem alloc] initWithString:NSLocalizedString(@"Chat.SwitchAdminsDescription", nil) height:42 flipped:YES];
