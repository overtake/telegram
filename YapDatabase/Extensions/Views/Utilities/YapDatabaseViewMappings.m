                ...
                view:(NSString *)inRegisteredViewName
{
	if ((self = [super init]))
	{
		...
		counts       = [NSMutableDictionary dictionaryWithSharedKeySetNew:sharedKeySet];
		rangeOptions = [NSMutableDictionary dictionaryWithSharedKeySetNew:sharedKeySet];
		dependencies = [NSMutableDictionary dictionaryWithSharedKeySetNew:sharedKeySet];
