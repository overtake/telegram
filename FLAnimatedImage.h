...
@property (nonatomic, strong) NSImage *(^imageDrawingBlock)(NSImage *);

@property (nonatomic, strong, readonly) NSImage *posterImage; // Guaranteed to be loaded; usually equivalent to `-imageLazilyCachedAtIndex:0`
